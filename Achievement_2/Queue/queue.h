...
struct cell* research_in_queue(struct queue* source, char* word_to_search); //Search a cell in a queue with the word_to_search word, return NULL if the word of the cell isn't found, the adress to the cell otherwise
