...
struct successors_cell* research_successors_cell(struct successors_queue* source, int position); //return the cell at the given position, NULL if doesn't exist
